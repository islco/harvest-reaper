"""
Django settings for Harvest Reaper project.
...
GOOGLE_CLIENT_SECRET = config('GOOGLE_CLIENT_SECRET', default='', cast=str)
...
WSGI_APPLICATION = 'harvestreaper.wsgi.application'
